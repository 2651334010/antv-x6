    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="背景" name="2">
        ...
        <div v-if="showImage">
		  ...
		  <!-- 图片选择列表 -->
          <el-row align="middle" v-if="showImage">
            <el-col :span="6">Select Image</el-col>
            <el-col :span="18">
              <el-select style="width: 100%;height:100%" v-model="bgImage">
                <el-option
                  ...
                  :label="image.label"
                >
                  <img :src="image.value" style="width: 100px; height: 100px; object-fit: cover;"/>
                </el-option>
              </el-select>
            </el-col>
          </el-row>
...
export default {
  data() {
    return {
      ...
      activeName: '1',
	  imageList: [
        { label: 'Image 1', value: require('../../../../../assets/bg1.png') },
        { label: 'Image 2', value: require('../../../../../assets/bg2.png') },
        { label: 'Image 3', value: require('../../../../../assets/bg3.png') },
        { label: 'Image 4', value: require('../../../../../assets/bg4.png') },
        { label: 'Image 5', value: require('../../../../../assets/bg5.png') },
        { label: 'Image 6', value: require('../../../../../assets/bg6.png') },
        { label: 'Image 7', value: require('../../../../../assets/bg7.png') },
        { label: 'Image 8', value: require('../../../../../assets/bg8.png') },
        { label: 'Image 9', value: require('../../../../../assets/bg9.png') }
      ]
    }
  },
  computed: {
    bgImage: {
      get() {
        return this.$store.state.flow.bgImage
      },
      set(val) {
        this.$store.commit('flow/updatebgImage', val)
      }
    },
	showGrid: {
      get() {
